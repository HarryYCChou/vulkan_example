...
VkShaderModule AppHello::create_shader_module(const vector<char>& code) {
...
void AppHello::create_framebuffers() {
...
void AppHello::create_command_pool() {
...
void AppHello::create_command_buffer() {
...
void AppHello::record_command_buffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
...
void AppHello::create_sync_objects() {
